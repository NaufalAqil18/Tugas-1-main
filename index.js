    ...
    rl.question('Pilih operasi (0-12): ', (pilihan) => {
        ...
        if ([1, 2, 3, 4, 5, 8, 10, 11].includes(pilihan)) {
            rl.question('Masukkan angka pertama: ', (angka1) => {
                rl.question('Masukkan angka kedua: ', (angka2) => {
                    ...
                    switch (pilihan) {
                        ...
                        case 5: hasil = pangkat(angka1, angka2); break;
                        case 8: hasil = modulus(angka1, angka2); break;
                        case 10: hasil = maksimum(angka1, angka2); break;
                        case 11: hasil = minimum(angka1, angka2); break;
                    }
            ...
            rl.question('Masukkan angka: ', (angka) => {
                ...
                let hasil;
                switch (pilihan) {
                    case 6: hasil = faktorial(angka); break;
                    case 7: hasil = isPrima(angka) ? 'Bilangan Prima' : 'Bukan Bilangan Prima'; break;
                    case 9: hasil = absolut(angka); break;
                    case 12: hasil = bulatkan(angka); break;
                }
                console.log(`Hasil: ${hasil}`);
                mulaiKalkulator();
            });
